...
public class RealizarConversion {
    ...
    public static void realizarConversion(Scanner sc) throws IOException, InterruptedException {
        ...
        try {
            ...
            System.out.println("|--------------------------------------------|");
            System.out.println("|--------   USD: Dolar Usa   ----------|");
            ...
            HttpRequest request = HttpRequest.newBuilder().uri(URI.create("https://v6.exchangerate-api.com/v6/9a29485a2b4ff7f5e09948c4/latest/" + divisa.getDivisaOriginal())).build();
